        ...
        <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                <div className={`p-8 text-center bg-${themeColor}-600`}>
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2">LogísticaAI</h1>
                    <p className="text-white/80">Plataforma Inteligente ERP</p>
                </div>
                ...
                <div className="p-8">
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="ejemplo@logistica.ai"
                            />
                        </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-xs text-slate-400">
                            ...
                            Credenciales por defecto: admin@logistica.ai / admin
                        </p>
                    </div>
                </div>
            </div>
